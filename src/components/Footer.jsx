  ...
  return (
    <div className="relative">
      <div className="absolute">
        <label className="swap swap-rotate top-20  bg-sky-400 pl-10 py-2 px-4 rounded-r-2xl">
      ...
      <footer className=" footer  sm:footer-horizontal bg-gray-800 text-base-content p-10 md:pt-36">
        <aside>
          <svg
            width="50"
            height="50"
